...
namespace Pemetaan_Ekonomi_Ketapang.Controller.Ekonomi
{
    ...
    {
        private tbl_jawabanTableAdapter tbl_jawabanControl = new tbl_jawabanTableAdapter();
        private db_ekonomi_ketapang ds = new db_ekonomi_ketapang();

        public int insertJawaban(tbl_jawaban temp)
        {
            return tbl_jawabanControl.insertJawaban(this.getLastIndexJawaban(), temp.id_ref_jawaban,temp.id_umat,temp.deskripsi_jawaban_1, temp.deskripsi_jawaban_2);
        }
        ...
        public int getLastIndexJawaban()
        {
            ...
            tbl_jawabanControl.Fill(ds.tbl_jawaban);
